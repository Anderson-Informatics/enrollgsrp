...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "e00b2666-d637-400a-b69e-430bc917937a",
...
const _79Tx7eVtlG_poNGtFxaPCykihb8cIb191FajkAYhZ9s = (function(nitro) {
...
const _M8FDQpxGdcycx5XrXWpXFd8C1uRmOq3U0gz_POl0 = defineNitroPlugin(async (nitroApp) => {
...
const FormSchemaModel = new Schema(
  {
    name: {
      type: String,
      required: true,
...
const FormSchema = mongoose.models.FormSchema || mongoose.model("FormSchema", FormSchemaModel);

const _KxzhkomvdjTak62yVcmAAvUwUMpP0tPbB8TbGAUzKM0 = defineNitroPlugin(async () => {
  try {
      ...
      fields: [
        {
          ...
          isRequired: true,
          order: 1,
          validations: [{ type: "required", message: "Child first name is required" }]
        },
        {
          id: "child_last_name",
          type: "text",
          ...
          isRequired: true,
          order: 2,
          validations: [{ type: "required", message: "Child last name is required" }]
        },
        {
        ...
        },
        {
          ...
          validations: [{ type: "required", message: "Gender is required" }]
        },
        {
          id: "child_race",
          type: "multiselect",
          ...
          validations: [{ type: "required", message: "Race selection is required" }]
        },
        {
          id: "child_ethnicity",
          type: "select",
          ...
          validations: [{ type: "required", message: "Ethnicity is required" }]
        },
        {
          id: "iep_status",
          type: "checkbox",
        ...
        },
        {
          ...
          validations: [{ type: "required", message: "Housing status is required" }]
        },
        {
          ...
          isRequired: true,
          order: 9,
          validations: [{ type: "required", message: "Parent first name is required" }]
        },
        {
          id: "parent_last_name",
          type: "text",
          ...
          isRequired: true,
          order: 10,
          validations: [{ type: "required", message: "Parent last name is required" }]
        },
        {
          id: "parent_email",
          type: "email",
        ...
        },
        {
          ...
          validations: [
            ...
            { type: "min", value: 1, message: "Household size must be at least 1" }
          ]
        },
        {
          id: "annual_income",
        ...
        },
        {
          ...
          validations: [{ type: "required", message: "Please select at least one school preference" }]
        }
      ],
      isActive: true,
...
const ROLE_LOOKUP = new Set(Object.keys(ROLE_PRESETS));
...
const _EN66kitlZ2SYnR1uZQ0Tbuie1YoQtDvxp1dcP6ixYW4 = defineNitroPlugin(async () => {
  try {
      ...
      return {
        updateOne: {
          ...
          update: {
            $setOnInsert: {
              code,
              name: (_b = (_a = PERMISSION_META[code]) == null ? void 0 : _a.name) != null ? _b : code,
              description: (_d = (_c = PERMISSION_META[code]) == null ? void 0 : _c.name) != null ? _d : code,
              category: (_f = (_e = PERMISSION_META[code]) == null ? void 0 : _e.category) != null ? _f : "general"
            }
          },
          upsert: true
        }
...
const plugins = [
  _79Tx7eVtlG_poNGtFxaPCykihb8cIb191FajkAYhZ9s,
_M8FDQpxGdcycx5XrXWpXFd8C1uRmOq3U0gz_POl0,
_KxzhkomvdjTak62yVcmAAvUwUMpP0tPbB8TbGAUzKM0,
_EN66kitlZ2SYnR1uZQ0Tbuie1YoQtDvxp1dcP6ixYW4
];
...
const _Zf6Qu7 = defineEventHandler(async (event) => {
...
async function logPermissionChange(event, details) {
  var _a;
  try {
    const actorId = (_a = event.context.auth) == null ? void 0 : _a.userId;
...
async function getCurrentPermissions(event) {
  var _a;
  const auth = event.context.auth;
  if (!(auth == null ? void 0 : auth.userId)) {
    throw createError$1({ statusCode: 401, message: "Not authenticated" });
  }
  const user = await UserModel.findById(auth.userId).select("permissions isActive").lean();
  if (!user || !user.isActive) {
    throw createError$1({ statusCode: 401, message: "User not found or inactive" });
  }
  return (_a = user.permissions) != null ? _a : [];
}
async function requirePermission(event, code) {
...
const _k0ClBO = defineCachedEventHandler(async (event) => {
  const url = getRequestURL(event);
  if (!url)
...
const _lazy_ebjFYE = () => import('../routes/api/admin/audit-log.get.mjs');
const _lazy_R6MCM_ = () => import('../routes/api/admin/form-schemas.get.mjs');
const _lazy_60C6_x = () => import('../routes/api/admin/form-schemas.post.mjs');
const _lazy_CjKKU3 = () => import('../routes/api/admin/form-schemas/_id_.delete.mjs');
const _lazy_laeVAw = () => import('../routes/api/admin/form-schemas/_id_.get.mjs');
const _lazy_9BmQWK = () => import('../routes/api/admin/form-schemas/_id_.patch.mjs');
const _lazy_J91aXd = () => import('../routes/api/admin/permissions.get.mjs');
const _lazy_G1Drfn = () => import('../routes/api/admin/users.get.mjs');
const _lazy_jA9XPK = () => import('../routes/api/admin/users/_id_.get.mjs');
const _lazy_MTYbfu = () => import('../routes/api/admin/users/_id_.patch.mjs');
const _lazy_1kzJcS = () => import('../routes/api/admin/users/_id/permissions.patch.mjs');
const _lazy_dhRJgY = () => import('../routes/api/auth/login.post.mjs');
const _lazy_8uhUbh = () => import('../routes/api/auth/register.post.mjs');
const _lazy_vP5Nmm = () => import('../routes/api/health.get.mjs');
const _lazy_Jorxxz = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '', handler: _Zf6Qu7, lazy: false, middleware: true, method: undefined },
  { route: '/api/admin/audit-log', handler: _lazy_ebjFYE, lazy: true, middleware: false, method: "get" },
  { route: '/api/admin/form-schemas', handler: _lazy_R6MCM_, lazy: true, middleware: false, method: "get" },
  { route: '/api/admin/form-schemas', handler: _lazy_60C6_x, lazy: true, middleware: false, method: "post" },
  { route: '/api/admin/form-schemas/:id', handler: _lazy_CjKKU3, lazy: true, middleware: false, method: "delete" },
  { route: '/api/admin/form-schemas/:id', handler: _lazy_laeVAw, lazy: true, middleware: false, method: "get" },
  { route: '/api/admin/form-schemas/:id', handler: _lazy_9BmQWK, lazy: true, middleware: false, method: "patch" },
  { route: '/api/admin/permissions', handler: _lazy_J91aXd, lazy: true, middleware: false, method: "get" },
  { route: '/api/admin/users', handler: _lazy_G1Drfn, lazy: true, middleware: false, method: "get" },
  { route: '/api/admin/users/:id', handler: _lazy_jA9XPK, lazy: true, middleware: false, method: "get" },
  { route: '/api/admin/users/:id', handler: _lazy_MTYbfu, lazy: true, middleware: false, method: "patch" },
  { route: '/api/admin/users/:id/permissions', handler: _lazy_1kzJcS, lazy: true, middleware: false, method: "patch" },
  { route: '/api/auth/login', handler: _lazy_dhRJgY, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/register', handler: _lazy_8uhUbh, lazy: true, middleware: false, method: "post" },
  { route: '/api/health', handler: _lazy_vP5Nmm, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_Jorxxz, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _k0ClBO, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Jorxxz, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, AuditLogModel as A, isEqual as B, isScriptProtocol as C, joinURL as D, klona as E, FormSchema as F, logAuditEntry as G, logPermissionChange as H, parseQuery as I, parseURL as J, publicAssetsURL as K, readBody as L, requirePermission as M, sanitizeStatusCode as N, setCookie as O, PERMISSION_CODES as P, useNitroApp as Q, useRuntimeConfig as R, verifyPassword as S, withQuery as T, UserModel as U, withTrailingSlash as V, withoutTrailingSlash as W, PermissionModel as a, baseURL as b, buildAssetsURL as c, createError$1 as d, decodePath as e, defineEventHandler as f, defineRenderHandler as g, defu as h, defuFn as i, deleteCookie as j, destr as k, encodePath as l, executeAsync as m, generateToken as n, getContext as o, getCookie as p, getPermissionsForRole as q, getQuery as r, getRequestHeader as s, getResponseStatus as t, getResponseStatusText as u, getRouteRules as v, getRouterParam as w, handler as x, hasProtocol as y, hashPassword as z };
