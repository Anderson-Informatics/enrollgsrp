import { Y as useHead, G as serverRenderer_cjs_prodExports, a5 as vueExports, _ as __nuxt_component_0$1 } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "antialiased bg-white dark:bg-[#020420] dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-[#020420] tracking-wide" }, _attrs))} data-v-d70e38b3><div class="max-w-520px text-center" data-v-d70e38b3><h1 class="font-semibold leading-none mb-4 sm:text-[110px] tabular-nums text-[80px]" data-v-d70e38b3>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.status)}</h1><h2 class="font-semibold mb-2 sm:text-3xl text-2xl" data-v-d70e38b3>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.statusText)}</h2><p class="mb-4 px-2 text-[#64748B] text-md" data-v-d70e38b3>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-d70e38b3>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.4.6_@babel+plugin-syntax-jsx@7.28.6_@babel+core@7.29.0__@babel+plugin-syntax-typ_e7d3b7e8c23a642b53a7f003edbacb10/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d70e38b3"]]);

export { error404 as default };
//# sourceMappingURL=error-404-CRxgszsa.mjs.map
