import { a5 as vueExports, a3 as useVModel, K as useAppConfig, Q as useComponentUI, S as useFormField, R as useFieldGroup, O as useComponentIcons, I as tv, G as serverRenderer_cjs_prodExports, b as Primitive, d as _sfc_main$d, e as _sfc_main$b, y as looseToNumber } from './server.mjs';
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (vueExports.unref(isLeading) || !!__props.avatar || !!slots.leading) {
              _push2(`<span data-slot="leading" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.leading({ class: vueExports.unref(uiProp)?.leading }))}"${_scopeId}>`);
            ...
            if (vueExports.unref(isTrailing) || !!slots.trailing) {
              _push2(`<span data-slot="trailing" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.trailing({ class: vueExports.unref(uiProp)?.trailing }))}"${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.7.1_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@netlify+_973710bc93b7c9087ede7bb193bd0af6/node_modules/@nuxt/ui/dist/runtime/components/Input.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as _ };
//# sourceMappingURL=Input-CnoieYvP.mjs.map
