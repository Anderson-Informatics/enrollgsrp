import { a5 as vueExports, K as useAppConfig, Q as useComponentUI, I as tv, m as formErrorsInjectionKey, o as formInputsInjectionKey, v as inputIdInjectionKey, n as formFieldInjectionKey, G as serverRenderer_cjs_prodExports, b as Primitive } from './server.mjs';
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (__props.label || !!slots.label) {
              _push2(`<div data-slot="labelWrapper" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.labelWrapper({ class: vueExports.unref(uiProp)?.labelWrapper }))}"${_scopeId}>`);
              ...
              if (__props.hint || !!slots.hint) {
                _push2(`<span${serverRenderer_cjs_prodExports.ssrRenderAttr("id", `${vueExports.unref(ariaId)}-hint`)} data-slot="hint" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.hint({ class: vueExports.unref(uiProp)?.hint }))}"${_scopeId}>`);
            ...
            if (__props.description || !!slots.description) {
              _push2(`<p${serverRenderer_cjs_prodExports.ssrRenderAttr("id", `${vueExports.unref(ariaId)}-description`)} data-slot="description" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.description({ class: vueExports.unref(uiProp)?.description }))}"${_scopeId}>`);
            ...
            _push2(`</div><div class="${serverRenderer_cjs_prodExports.ssrRenderClass([(__props.label || !!slots.label || __props.description || !!slots.description) && ui.value.container({ class: vueExports.unref(uiProp)?.container })])}"${_scopeId}>`);
            ...
            if (props.error !== false && (typeof error.value === "string" && error.value || !!slots.error)) {
              _push2(`<div${serverRenderer_cjs_prodExports.ssrRenderAttr("id", `${vueExports.unref(ariaId)}-error`)} data-slot="error" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.error({ class: vueExports.unref(uiProp)?.error }))}"${_scopeId}>`);
              ...
              _push2(`<div${serverRenderer_cjs_prodExports.ssrRenderAttr("id", `${vueExports.unref(ariaId)}-help`)} data-slot="help" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.help({ class: vueExports.unref(uiProp)?.help }))}"${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.7.1_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@netlify+_973710bc93b7c9087ede7bb193bd0af6/node_modules/@nuxt/ui/dist/runtime/components/FormField.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as _ };
//# sourceMappingURL=FormField-KZZrgtfg.mjs.map
